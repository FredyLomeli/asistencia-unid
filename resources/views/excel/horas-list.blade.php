...
<body>
    <div class="content">
        ...
        <table>
            <td colspan="6"><b>ID:</b> {{ $docente->id_banner }} &nbsp;&nbsp; <b>Docente:</b> {{ $docente->nombre }} {{ $docente->apellido_paterno }} {{ $docente->apellido_materno }}</td>
        </table>
            <table class="show">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    @endforeach
                    <tr>
                        <td colspan="6">Horas trabajadas totales : {{ $docente->horas_trabajadas }}</td>
                    </tr>
                    @else
                    <tr>
