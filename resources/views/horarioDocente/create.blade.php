    ...
    <div class="col-md-12">
        <div class="box box-info">
            <form class="form-horizontal" method="post"
                action="{{ route('horarioDocente.store') }}">
                    ...
                    <div class="form-group {{ $errors->has('descripcion') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-3">
                            <input type="text" minlength="8" maxlength="250" class="form-control" id="descripcion" name="descripcion"
                                placeholder="Tecnologia Educativa"
                    ...
                    <div class="form-group {{ $errors->has('dia') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-5">
                            <select class="form-control" id="dia" name="dia">
                                <option value="0" {{ old('dia') == 0 ? 'selected' : '' }}>
                                    Domingo</option>
                                <option value="1" {{ old('dia') == 1 ? 'selected' : '' }}>
                                    Lunes</option>
                                <option value="2" {{ old('dia') == 2 ? 'selected' : '' }}>
                                    Martes</option>
                                <option value="3" {{ old('dia') == 3 ? 'selected' : '' }}>
                                    Miercoles</option>
                                <option value="4" {{ old('dia') == 4 ? 'selected' : '' }}>
                                    Jueves</option>
                                <option value="5" {{ old('dia') == 5 ? 'selected' : '' }}>
                                    Viernes</option>
                                <option value="6" {{ old('dia') == 6 ? 'selected' : '' }}>
                                    Sabado</option>
                            </select>
                            @if ($errors->has('dia'))
                            <span class="help-block">
                    ...
                    <div class="form-group {{ $errors->has('grupo') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-3">
                            <input type="text" maxlength="250" class="form-control" id="grupo" name="grupo"
                                placeholder="6to-b" value="{{ old('grupo') }}">
                            @if ($errors->has('grupo'))
                            <span class="help-block">
...
<script>
    var vm = new Vue({
        el: '#frexal',
        data: {
            fechaInicio : '{{ old('fecha_vig_ini', $calendarioActual->fechaInicio)}}',
            fechaFin : '{{ old('fecha_vig_fin', $calendarioActual->fechaFin)}}',
            calendario: '{{ old('calendario', $calendarioActual->nombre.'|'.date("d/m/Y", strtotime($calendarioActual->fechaInicio)).' | '.date("d/m/Y", strtotime($calendarioActual->fechaFin))) }}',
            calendar: '{{ old('calendario') === 'Personalizado||' ? 'Personalizado' : old('calendario', $calendarioActual->nombre) }}',
        },
    });
