                ...
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-xs-3 col-lg-1">
                            <a class="btn btn-default pull-right" href="{{ route('crn.show', $crn) }}"><i
                    ...
                    <div class="form-group {{ $errors->has('estado') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-5">
                            <select class="form-control" id="estado" name="estado">
                                <option value="1" {{ old('estado', $crn->estado) == 1 ? 'selected' : '' }}>Activo
                                </option>
                                <option value="0" {{ old('estado', $crn->estado) == 0 ? 'selected' : '' }}>Inactivo
                                </option>
                            </select>
                            @if ($errors->has('estado'))
                            <span class="help-block">
