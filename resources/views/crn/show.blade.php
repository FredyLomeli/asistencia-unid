        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <div class="row">
                    <div class="col-xs-9 col-lg-7">
                        <a class="btn btn-default pull-right" href="{{ route('crn.index') }}"><i class="fa fa-list"></i>
                            Regresar</a>
                    </div>
                    <div class="col-xs-3 col-lg-1">
                        <a class="btn btn-default pull-right" href="{{ route('crn.edit', $crn) }}"><i
            ...
            <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-3">
                            <input type="text" minlength="8" maxlength="10" class="form-control" id="crn" name="crn"
                                placeholder="63454" value="{{ $crn->crn }}" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <input type="text" maxlength="100" class="form-control" id="nombre" name="nombre"
                                placeholder="Tecnologia Educativa" value="{{ $crn->nombre }}" readonly>
                        </div>
                    </div>
                    <div class="form-group ">
                ...
                <div class="box-footer">
                    <div class="row">
                        <div class="col-xs-9 col-lg-7">
                            <a class="btn btn-default pull-right" href="{{ route('crn.index') }}"><i
