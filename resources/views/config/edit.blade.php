        ...
        <div class="box-header with-border">
            <div class="row">
                ...
                <div class="col-xs-3 col-lg-1">
                    <a class="btn btn-default pull-right" href="{{ route('config.show', $configuracion) }}"><i class="fa fa-times"></i> Cancelar</a>
                </div>
                <div class="col-xs-3 col-lg-1">
        ...
        <div class="box-body">
            <div class="form-group {{ $errors->has('tipo') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-5">
                    <select class="form-control" id="tipo" name="tipo" v-model="tipo">
                        <option value="4" {{ old('tipo', $configuracion->tipo) == 4 ? 'selected' : '' }}>Calendario</option>
                        <option value="5" {{ old('tipo', $configuracion->tipo) == 5 ? 'selected' : '' }}>Asueto</option>
                        <option value="3" {{ old('tipo', $configuracion->tipo) == 3 ? 'selected' : '' }}>Contraseña</option>
                        <option value="6" {{ old('tipo', $configuracion->tipo) == 6 ? 'selected' : '' }}>Nombre de Campos (tabla)</option>
                        <option value="7" {{ old('tipo', $configuracion->tipo) == 7 ? 'selected' : '' }}>Campos de Tabla</option>
                        <option value="8" {{ old('tipo', $configuracion->tipo) == 8 ? 'selected' : '' }}>Tamaño de Campos (tabla)</option>
                        <option value="9" {{ old('tipo', $configuracion->tipo) == 9 ? 'selected' : '' }}>Nombre de Campos Filtro (tabla)</option>
                        <option value="10" {{ old('tipo', $configuracion->tipo) == 10 ? 'selected' : '' }}>Campos de filtro (tabla)</option>
                        <option value="11" {{ old('tipo', $configuracion->tipo) == 11 ? 'selected' : '' }}>Limite de Regristro (tabla)</option>
                    </select>
                    @if ($errors->has('tipo'))
            ...
            <div class="form-group {{ $errors->has('nombre') ? ' has-error' : '' }}">
                <label for="nombre" class="col-lg-3 control-label">
                    ...
                    Nombre:</label>
                <div class="col-lg-3">
                    <input type="text" minlength="1" maxlength="250" class="form-control" id="nombre" name="nombre"
                    placeholder="AsuetoBenito2020" value="{{ old('nombre', $configuracion->nombre) }}" >
                    @if ($errors->has('nombre'))
                    <span class="help-block">
            ...
            <div class="form-group {{ $errors->has('datos') ? ' has-error' : '' }}"
                ...
                <div class="col-lg-5">
                    ...
                    placeholder="configuracion" value="{{ old('datos', $configuracion->datos)}}" :disabled="ban === true">
                    @if ($errors->has('datos'))
                    <span class="help-block">
            ...
            <div class="form-group {{ $errors->has('fec_ini') ? ' has-error' : '' }}"
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                        ...
                        id="fec_ini" name="fec_ini" value="{{ old('fec_ini', $configuracion->fec_ini)}}" data-mask :disabled="ban === true">
                        @if ($errors->has('fec_ini'))
                        <span class="help-block">
            ...
            <div class="form-group {{ $errors->has('fec_fin') ? ' has-error' : '' }}"
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                        <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                        <input type="text" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'"
                        id="fec_fin" name="fec_fin" value="{{ old('fec_fin', $configuracion->fec_fin)}}" data-mask :disabled="ban === true">
                        @if ($errors->has('fec_fin'))
                        <span class="help-block">
            ...
            <div class="form-group {{ $errors->has('fecha') ? ' has-error' : '' }}"
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                        <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                        <input type="text" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'"
                        id="fecha" name="fecha" value="{{ old('fecha', $configuracion->fecha)}}" data-mask :disabled="ban === true">
                        @if ($errors->has('fecha'))
                        <span class="help-block">
