        ...
        <div class="box-body">
            <div class="form-group {{ $errors->has('tipo') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-5">
                    <select class="form-control" id="tipo" name="tipo" v-model="tipo">
                        ...
                        <option value="6" {{ old('tipo') == 6 ? 'selected' : '' }}>Nombre de Campos (tabla)</option>
                        <option value="7" {{ old('tipo') == 7 ? 'selected' : '' }}>Campos de Tabla</option>
                        <option value="8" {{ old('tipo') == 8 ? 'selected' : '' }}>Tamaño de Campos (tabla)</option>
                        <option value="9" {{ old('tipo') == 9 ? 'selected' : '' }}>Nombre de Campos Filtro (tabla)</option>
                        <option value="10" {{ old('tipo') == 10 ? 'selected' : '' }}>Campos de filtro (tabla)</option>
                        <option value="11" {{ old('tipo') == 11 ? 'selected' : '' }}>Limite de Regristro (tabla)</option>
                    </select>
                    @if ($errors->has('tipo'))
            ...
            <div class="form-group {{ $errors->has('nombre') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-3">
                    ...
                    placeholder="AsuetoBenito2020" value="{{ old('nombre') }}" >
                    @if ($errors->has('nombre'))
                    <span class="help-block">
            ...
            <div class="form-group {{ $errors->has('fec_ini') ? ' has-error' : '' }}"
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                        ...
                        id="fec_ini" name="fec_ini" value="{{ old('fec_ini')}}" data-mask :disabled="ban === true">
                        @if ($errors->has('fec_ini'))
                        <span class="help-block">
            ...
            <div class="form-group {{ $errors->has('fec_fin') ? ' has-error' : '' }}"
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                        <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                        <input type="text" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'"
                        id="fec_fin" name="fec_fin" value="{{ old('fec_fin')}}" data-mask :disabled="ban === true">
                        @if ($errors->has('fec_fin'))
                        <span class="help-block">
            ...
            <div class="form-group {{ $errors->has('fecha') ? ' has-error' : '' }}"
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                        <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                        <input type="text" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'"
                        id="fecha" name="fecha" value="{{ old('fecha')}}" data-mask :disabled="ban === true">
                        @if ($errors->has('fecha'))
                        <span class="help-block">
